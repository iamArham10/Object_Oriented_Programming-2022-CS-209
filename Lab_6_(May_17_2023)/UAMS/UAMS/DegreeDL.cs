...
namespace UAMS
{
    class DegreeDL
    {
        ...
        public static bool Is_Degree_Exists(Degree degree)
        {
            foreach(Degree addeddegrees in degrees)
            {
                if (degree.Title == addeddegrees.Title)
                {
                    return true;
                }
            }
        ...
        public static bool Is_Degrees_Available()
        {
            if (degrees.Count > 0)
            {
                return true;
